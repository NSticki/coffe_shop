...
@section('content')
    ...
    <div class="container-fluid">
        <form class="form" action="{{ route('stores.store') }}" method="POST">
            <div class="row">
                    ...
                    <div class="row mt-3">
                        <div class="col-12">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-5">
                                    <input type="text" id="store_name" name="store_name" placeholder="Название"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-5">
                                    <input type="text" id="store_address" name="store_address" placeholder="Адрес"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-5">
                                    <input type="text" id="store_phone" name="store_phone" placeholder="Телефон"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-2">
                                    <input type="text" id="time_from" name="time_from" placeholder="С"
                                           class="datepicker form-control @error('time_from') is-invalid @enderror">
                                    @error('time_from')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="col-md-2">
                                    <input type="text" id="time_to" name="time_to" placeholder="До"
                                           class="datepicker form-control @error('time_to') is-invalid @enderror">
                                    @error('time_to')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
