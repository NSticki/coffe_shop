...
@section('content')
    ...
    <div class="container-fluid">
        <form class="form" action="{{ route('users.update', $data['user']['id']) }}" method="POST">
            <div class="row">
                    ...
                    <div class="row mt-3">
                        <div class="col-12">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-5">
                                    <input type="text" id="name" name="name" placeholder="Имя" value="{{ $data['user']['name'] }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-5">
                                    <input type="text" id="lastname" name="lastname" placeholder="Фамилия" value="{{ $data['user']['lastname'] }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-5">
                                    <input type="text" id="telephone" name="telephone" placeholder="Телефон" value="{{ $data['user']['telephone'] }}"
...
{{--                                <div class="col-md-5">--}}
{{--                                    <input type="password" id="password" name="password" placeholder="Пароль" value="{{ $data['user']['password'] }}"--}}
...
{{--                                <div class="col-md-5">--}}
{{--                                    <input type="password" id="password-confirm" name="password-confirm" placeholder="Пароль" value="{{ $data['user']['password'] }}"--}}
{{--                                           class="form-control @error('password') is-invalid @enderror">--}}
{{--                                    @error('password')--}}
{{--                                    <span class="invalid-feedback" role="alert">--}}
{{--                                        <strong>{{ $message }}</strong>--}}
                                ...
                                <div class="col-md-5">
                                    <select class="custom-select" name="role_id" id="role_id">
                                        @foreach($data['user_roles'] as $role)
                                            <option {{ $role['id'] == $data['user']['role_id'] ? 'selected' : ''}}
